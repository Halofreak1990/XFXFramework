	...
	namespace Windows
	{
		namespace Controls
		{
			namespace Primitives
			{
				...
				const char* ToggleButton::ToString() const
				{
					return String::Format("{ToggleButton Content:%s IsChecked:%s}", (Content) ? Content->ToString() : "", (IsChecked != null) ? Boolean::ToString(IsChecked.getValue()) : "null");
				}
