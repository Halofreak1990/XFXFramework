...
#define NV20_VP_INST_OPCODE_NOP	0x0
...
#define NV20_VP_INST_INPUT_SRC_MASK				(0xF << 9)
...
#define	NV20_VP_INST_CONST_DEST_FLAG				(1<<11)
#define NV20_VP_INST_CONST_DEST_SHIFT				3
#define NV20_VP_INST_CONST_DEST_MASK				(0xFF<< 3)
#define NV20_VP_INST_DEST_SHIFT					3
#define NV20_VP_INST_DEST_MASK					(0xF << 3)
#define NV20_VP_INST_DEST_POS	0
#define NV20_VP_INST_DEST_COL0	3
#define NV20_VP_INST_DEST_COL1	4
#define NV20_VP_INST_DEST_FOG	5
#define NV20_VP_INST_DEST_PTS	6
#define NV20_VP_INST_DEST_TC(n)	(9+n)
#define NV20_VP_INST_DEST_SCA					(1<<2)
#define NV20_VP_INST_INDEX_CONST				(1<<1)
#define NV20_VP_INST_LAST_INST					(1<<0)
#define NV20_VP_INST3_KNOWN ( \
	NV20_VP_INST_SRC2L_MASK | \
	NV20_VP_INST_VTEMP_WRITEMASK_MASK | \
	NV20_VP_INST_DEST_TEMP_ID_MASK | \
	NV20_VP_INST_STEMP_WRITEMASK_MASK | \
	NV20_VP_INST_DEST_WRITEMASK_MASK | \
	NV20_VP_INST_CONST_DEST_MASK | \
	NV20_VP_INST_DEST_MASK | \
	NV20_VP_INST_DEST_SCA | \
	NV20_VP_INST_INDEX_CONST | \
	NV20_VP_INST_LAST_INST \
	)
